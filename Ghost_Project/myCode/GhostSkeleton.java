...
public class GhostSkeleton {
    ...
    private static myCode.FileManager fileManager;
    private static myCode.Dictionary dictionary;
        ...
        while(true) {
            ...
            if(fileManager.hasChanged()) {
                ...
                if (turnParser.isMyTurn(lastLine)) {
                     ...
                     */
                    System.out.println(wordFragment);
                    char next_letter = MyMarkovChain.markov(dictionaryFilePath, wordFragment.toString());

                    String nextLetter = Character.toString(next_letter);
